...
class MeanShift:
    ...
    def _fit_parallel(self) -> None:
        ...
        # selected_seeds_indices = np.random.choice(shift_points.shape[0], 5, replace=False)
        # shift_points = shift_points[selected_seeds_indices]
    ...
    def _prune_cluster_step1(self) -> None:
        ...
        # print("check brefore prune: ", clusters_to_remove, type(clusters_to_remove), clusters_to_remove.shape)

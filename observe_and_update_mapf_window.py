...
def test_online():
    ...
    onlineUpdateMoD = OnlineUpdateMoD(
        ...
        current_cliff=None,
        output_cliff_folder=f"online_mod_res_mapf/window_forgettime",
        save_fig_folder=f"save_fig_online")
    
    for version in ["initialv2_window", "updatev2_window"]:
...
with open(f"online_mod_res_mapf/runtime/window_train.txt", "w") as f:

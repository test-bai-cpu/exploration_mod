...
def test_online_on_thor_magni():
    ...
    onlineUpdateMoD = OnlineUpdateMoD(
        ...
        current_cliff=None,
        output_cliff_folder=f"online_mod_res_magni_test1",
    ...
    thor_magni = InThorMagniDataset('config_magni.yaml', raw_data_file='thor_magni_combine_add_time_all_dates_for_train_cliff_correct_ori/A.csv')
    ...
    thor_magni = InThorMagniDataset('config_magni.yaml', raw_data_file='thor_magni_combine_add_time_all_dates_for_train_cliff_correct_ori/B.csv')
